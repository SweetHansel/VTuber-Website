...
function ContentModalContent({
  type,
  data,
}: Readonly<{ type: ContentType; data: Record<string, unknown> }>) {
...
function SongModalContent({
  id,
  data,
}: Readonly<{ id: string | null; data: Record<string, unknown> }>) {
