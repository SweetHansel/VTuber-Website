...
export function getModel(
  model: number | Model | null | undefined,
): Model | undefined {
...
export function getAlbum(
  album: number | Album | null | undefined,
): Album | undefined {
...
export function getSocial(
  social: number | Social | null | undefined,
): Social | undefined {
...
export function useModels(type?: "2d" | "3d", options?: UseHookOptions) {
  ...
  const filteredModels = models
    ? type
      ? models.filter((m) => {
          if (type === "2d")
            return ["live2d", "png", "other-2d"].includes(m.modelType);
          if (type === "3d")
            return ["vrm", "vsfavatar", "mmd", "other-3d"].includes(
              m.modelType,
            );
          return true;
        })
...
export function useInteractiveMedia(location?: string) {
  ...
  return useFetch<InteractiveMedia | InteractiveMedia[]>(url, {
    skip: !location && false,
  });
}
